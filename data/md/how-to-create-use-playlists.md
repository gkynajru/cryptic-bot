...
**3.** Click on the **pencil** icon to change the playlist name. On 2.0, simply click on the name.
...
**6.** Click on the **Pencil** icon next to the item duration, as shown below, to change the duration of the item on the playlist. On 2.0, simply click the number itself.
